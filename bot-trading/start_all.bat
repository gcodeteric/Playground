...
rem Apagar lock files de sessoes anteriores
...
start "Dashboard" cmd /k "cd /d %~dp0 && call venv\Scripts\activate.bat && streamlit run dashboard/app.py --server.port 8501 --server.headless true"
